...
public:
    ...
    { 
        ...
        mcl2 = mcl;
        ros::Subscriber scansub = private_nh_.subscribe<sensor_msgs::LaserScan>("/laserscan", 1, boost::bind(&Testing::scanCallback, this, _1));
        ros::Subscriber odomsub = private_nh_.subscribe<nav_msgs::Odometry>("/ground_truth/odom", 1, boost::bind(&Testing::odomCallback, this, _1));
        ros::Subscriber mapsub = private_nh_.subscribe<nav_msgs::OccupancyGrid>("/map", 1, boost::bind(&Testing::mapCallback, this, _1));
    };
